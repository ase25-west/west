...
assert_return(() => call($1, "store", [-4n, 42]));

// memory_trap64.wast:22
assert_return(() => call($1, "load", [-4n]), 42);

// memory_trap64.wast:23
assert_trap(() => call($1, "store", [-3n, 13]));

// memory_trap64.wast:24
assert_trap(() => call($1, "load", [-3n]));

// memory_trap64.wast:25
assert_trap(() => call($1, "store", [-2n, 13]));

// memory_trap64.wast:26
assert_trap(() => call($1, "load", [-2n]));

// memory_trap64.wast:27
assert_trap(() => call($1, "store", [-1n, 13]));

// memory_trap64.wast:28
assert_trap(() => call($1, "load", [-1n]));

// memory_trap64.wast:29
assert_trap(() => call($1, "store", [0n, 13]));

// memory_trap64.wast:30
assert_trap(() => call($1, "load", [0n]));

// memory_trap64.wast:31
assert_trap(() => call($1, "store", [2_147_483_648n, 13]));

// memory_trap64.wast:32
assert_trap(() => call($1, "load", [2_147_483_648n]));
