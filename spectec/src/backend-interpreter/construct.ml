...
let al_to_extern_type = function (* semantic *)
...
let al_to_import_desc' = function (* syntactic *)
  | CaseV ("FUNC", [typeuse]) -> FuncImport (al_to_typeuse typeuse)
  ...
  | CaseV ("TAG", [ typeuse ]) -> TagImport (al_to_typeuse typeuse)
  | v -> error_value "import desc" v
let al_to_import_desc idesc = al_to_import_desc' idesc @@ no_region
